...
If this endpoint is not defined — or is removed — 2FA support is automatically disabled, without affecting the normal authentication flow.
...
The authentication works through **Laravel session cookies** (Sanctum).
...
### Why No 2FA Header Is Needed?

With Sanctum:

- Authentication is session-based
- Laravel already knows the authenticated user
- 2FA validation happens inside the same session
