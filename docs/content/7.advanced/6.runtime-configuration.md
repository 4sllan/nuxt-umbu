...
runtimeConfig: {
  secret: {
    ...
    social: {
      client_id: process.env.SOCIAL_CLIENT_ID,
      client_secret: process.env.SOCIAL_CLIENT_SECRET,
...
# .env.production
PASSPORT_CLIENT_ID=prod_client_id
PASSPORT_CLIENT_SECRET=prod_client_secret

# .env.development
PASSPORT_CLIENT_ID=dev_client_id
PASSPORT_CLIENT_SECRET=dev_client_secret
```
...
```dockerfile
# Dockerfile
ENV PASSPORT_CLIENT_ID=your_client_id
ENV PASSPORT_CLIENT_SECRET=your_client_secret
```
...
export PASSPORT_CLIENT_ID=your_client_id
export PASSPORT_CLIENT_SECRET=your_client_secret
