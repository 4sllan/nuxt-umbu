...
Nuxt Umbu integrates seamlessly with Laravel Passport to provide secure, cookie-based authentication for your Nuxt application.
...
baseURL`, which points to your Laravel API.
...
| Parameter                            | Description                                 | Default                               |
| ------------------------------------ | ------------------------------------------- | ------------------------------------- |
| `csrf`                               | Endpoint used to retrieve CSRF cookie       | `/Passport/csrf-cookie`                |
| `provider`                           | Authentication provider                     | `Passport`                             |
| `strategies.client.redirect.login`   | Redirect path after login                   | `undefined`                           |
| `strategies.client.redirect.logout`  | Redirect path after logout                  | `undefined`                           |
| `strategies.client.user.property`    | Property containing authenticated user data | `user`                                |
| `strategies.client.endpoints.login`  | Login endpoint configuration                | `{ url: '/login', method: 'post' }`   |
| `strategies.client.endpoints.user`   | Authenticated user endpoint                 | `{ url: '/api/user', method: 'get' }` |
| `strategies.client.endpoints.logout` | Logout endpoint                             | `{ url: '/logout', method: 'post' }`  |
| `strategies.client.endpoints.2fa`    | Two-factor authentication endpoint          | `undefined`                           |
